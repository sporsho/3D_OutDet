...
def get_unique_labels(data_dir, split):
    files = glob.glob(os.path.join(data_dir, 'sequences', str(split).zfill(2), 'labels', '*.label'))
    out_dict = dict()
    for f in files:
...
if __name__ == '__main__':
    # Training settings
    data_dir = '/var/local/home/aburai/DATA/SnowyKITTIV2'
    config_file = '/var/local/home/aburai/3D_OutDet/binary_desnow_kitti.yaml'
